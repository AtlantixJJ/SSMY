...
def image_preprocessing(image_buffer, bbox, train, thread_id=0):
  ...
  return image
def image_preprocessing_ss(image_buffer, label_buffer, train, thread_id=0):
  """Decode and preprocess one image for evaluation or training.
...
def batch_inputs(dataset, batch_size, train, num_preprocess_threads=None,
  ...
  with tf.name_scope('batch_processing'):
    ...
    for thread_id in range(num_preprocess_threads):
      ...
      image_buffer, label_buffer = parse_example_proto(example_serialized)
      image, label = image_preprocessing_ss(image_buffer, label_buffer, train, thread_id)
